...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mt-4 mb-4 text-gray-800">Data Barang</h1>
    <a href="<?php echo site_url('Barang/Barang_Controller/pageTambah') ?>" class="btn btn-primary">Tambah Data</a>
    <div><br></div>
    <div class="row">
        <!-- Column -->
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('Barang/Barang_Controller/edit/' . $data->IdBarang) ?>" class="btn btn-success">Ubah</a>
                                            <a class="btn btn-xs btn-danger" data-toggle="modal" data-target="#modal_hapus<?php echo $data->IdBarang; ?>" data-backdrop="false"> Hapus</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
