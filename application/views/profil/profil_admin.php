                            ...
                            <div class="card-block" style="padding-left: 20px; padding-top: 10px">
                                <section class="content">
                                    <?php foreach ($ms_pengguna as $data) { ?>
                                        <form role="form" action="<?php echo site_url('Ms_Pengguna/Ms_Pengguna_Controller/updateAdmin'); ?>" method="post">
                                            <div class="box-body">
                                                ...
                                                <div class="col-lg-5 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Masukkan NRP" name="nrp" value="<?php echo $data->nrp ?>" required>
                                                </div>
                                                ...
                                                <div class="col-lg-5 mb-3">
                                                    <a href="<?php echo site_url('Ms_Pengguna/Ms_Pengguna_Controller') ?>" class="btn btn-secondary">Kembali</a>
                                                    &nbsp;&nbsp;
