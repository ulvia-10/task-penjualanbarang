...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mt-4 mb-4 text-gray-800">Ubah Data Pelanggan</h1>
    <div><br></div>
    <div class="row">
        <!-- Column -->
                ...
                <div class="card-block" style="padding-left: 20px; padding-top: 10px">
                    <section class="content">
                        <?php foreach ($Pelanggan as $data) { ?>
                            <form role="form" action="<?php echo site_url('Pelanggan/Pelanggan_Controller/update') ; ?>" method="post">
                                <div class="box-body">
                                    <input type="text" hidden="true" class="form-control" name="IdPelanggan" value="<?php echo $data->IdPelanggan ?>" required>

                                    <div class="col-lg-5 mb-3">
                                        <label for="name">Nama<span style="color:red"> * </span></label>
                                        <input type="text" class="form-control" id="name" name="NamaPelanggan" placeholder="Masukkan Nama Pelanggan" value="<?php echo $data->NamaPelanggan ?>" required>
                                    </div>
                                    <div class="col-lg-5 mb-3">
